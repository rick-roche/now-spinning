...
export const ErrorCode = {
  ...
  RECENT_SCROBBLES_ERROR: "RECENT_SCROBBLES_ERROR",
  INTERNAL_SERVER_ERROR: "INTERNAL_SERVER_ERROR",
  NOT_FOUND: "NOT_FOUND",
  SESSION_NOT_FOUND: "SESSION_NOT_FOUND",
  SESSION_MUTATION_CONFLICT: "SESSION_MUTATION_CONFLICT",
  SCROBBLE_OPERATION_CONFLICT: "SCROBBLE_OPERATION_CONFLICT",
